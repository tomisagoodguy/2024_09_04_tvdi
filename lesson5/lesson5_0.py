...
class Window(ThemedTk):
    def __init__(self, *args, **kwargs):
        ...
        style.configure('Main.TButton', font=(
            "Arial", 15, "bold"), foreground="black")
        style.configure('Main1.TButton', font=("Arial", 15, "bold"),
                        background="lightblue", foreground="sky blue")
        style.configure('Main2.TButton', font=(
            "Arial", 15, "italic"), foreground="red")
        style.configure('Main3.TButton', font=(
            "Arial", 15, "underline"), foreground="violet")
        style.configure('Main4.TButton', font=(
            "Arial", 15, "overstrike"), foreground="black")
        # ================================start topframe====================================
        topFrame = ttk.Frame(self, borderwidth=1, relief='groove')
        self.btn1 = ttk.Button(topFrame, text="加入購物車",
                               style='Main.TButton', command=self.user_click1)
        self.btn1.pack(side='left', expand=True, fill='both', padx=10)
        btn2 = ttk.Button(topFrame, text="我的最愛",
                          style='Main.TButton', command=self.user_click2)
        btn2.pack(side='left', expand=True, fill='both')
        btn3 = ttk.Button(topFrame, text="個人資料",
                          style='Main.TButton', command=self.user_click3)
        btn3.pack(side='left', expand=True, fill='both', padx=10)
        topFrame.pack(padx=10, pady=(10, 0), ipadx=10,
                      ipady=10, expand=True, fill='both')
        # ================================end topframe=====================================

        # ================================start bottomframe================================
        bottomFrame = ttk.Frame(
            self, height=300, borderwidth=1, relief='groove')

        # ================================start leftframe================================
        leftFrame = ttk.Frame(bottomFrame, width=100,
                              height=300, borderwidth=2, relief='groove')
        ...
        # ================================start centerframe================================
        centerFrame = ttk.Frame(bottomFrame, width=100,
                                height=300, borderwidth=2, relief='groove')
        ...
        # ================================start rightframe==============================
        rightFrame = ttk.Frame(bottomFrame, width=100,
                               height=300, borderwidth=2, relief='groove')
